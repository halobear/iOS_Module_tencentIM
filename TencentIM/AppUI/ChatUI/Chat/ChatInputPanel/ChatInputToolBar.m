...
- (instancetype)init
{
    if (self = [super init])
    {
        self.backgroundColor = kBackGroundColor_white;
    }
    return self;
}
...
- (void)addOwnViews
{
    ...
    _audioPressed.layer.cornerRadius = 15;
    _audioPressed.backgroundColor = kBackGroundColor_gray;
...
//    [_audioPressed setBackgroundImage:[UIImage imageWithColor:kLightGrayColor] forState:UIControlStateSelected];
    ...
    [_audioPressed setTitleColor:kTextColor_gray forState:UIControlStateNormal];
...
//    _textView.layer.borderWidth = 0.6;
    ...
    _textView.tintColor = kColorRed;
    _textView.textColor = kTextColor_Black;
    _textView.backgroundColor = [UIColor colorWithHexString:@"0xF8F8F8"];
    _textView.textContainerInset = UIEdgeInsetsMake(6, 12, 6, 12);
    UITapGestureRecognizer *tap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(textChangeAction)];
    [_textView addGestureRecognizer:tap];
    [self addSubview:_textView];
    
    _plhoderView = [[UILabel alloc]init];
    _plhoderView.text = @"对Ta发送消息";
    _plhoderView.textColor = kTextColor_gray;
    _plhoderView.font = kAppMiddleTextFont;
    [_textView addSubview:_plhoderView];
...
- (void)relayoutFrameOfSubViews
{
    ...
    _more.centerY = _audioPressed.centerY;
    _emoj.centerY = _audioPressed.centerY;
    ...
    _plhoderView.frame = CGRectMake(15, 8, _textView.width-20, 14);
