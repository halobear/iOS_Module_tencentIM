...
//每秒刷新30次
#define kReduceWidth (kScreen_Width/kRecordMaxTime/kRefreshRate)
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
                         [HaloTool.sharedTool alterViewControllerWithTitle:@"提示" message:@"请在设备的\"设置-隐私-相机\"中允许访问相机。" cancleTitle:@"确定" otherTitle:@"" otherSelectBlcok:^{}];
#pragma clang diagnostic pop
                         [ws onCancelBtn:self->_cancelBtn];
                         return;
                     }
                 });
             }];
    ...
    if (!_isCancelRecord)
    {
        ...
        [self convertToMP4:urlAsset videoPath:videoPath succ:^(NSString *path) {
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                [self onCancelBtn:self->_cancelBtn];
            });
...
- (void)layoutFoucsView:(CGPoint)point
{
    ...
    [UIView animateWithDuration:0.5 animations:^{
        ...
        self->_focusView.transform = CGAffineTransformMakeScale(0.5, 0.5);
        self->_focusView.alpha = 1;
...
- (void)startAnimation
{
    [UIView animateWithDuration:0.5 animations:^{
        ...
        self->_upSlidePanel.hidden = NO;
        
        self->_recordBtn.alpha = 0;
        self->_recordBtn.transform = CGAffineTransformMakeScale(2.0, 2.0);
