...
+ (NSArray *)materialIDs {
    NSArray *materials = @[@"video_jinmao_iOS",
                           @"video_fenlu_iOS",
                           @"video_leipen_iOS",
                           @"video_nethot_iOS",
                           @"video_fox_iOS",
...
+ (NSString *)thumbUrl:(NSString *)materialID {
    NSString *thumbUrl = [NSString stringWithFormat:@"http://st1.xiangji.qq.com/yunmaterials/%@.png", materialID];
    return thumbUrl;
}

+ (NSString *)packageUrl:(NSString *)materialID {
    NSString *packageUrl = [NSString stringWithFormat:@"http://st1.xiangji.qq.com/yunmaterials/%@.zip", materialID];
    return packageUrl;
}
