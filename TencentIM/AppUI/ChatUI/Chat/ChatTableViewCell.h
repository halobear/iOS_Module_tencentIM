...
@end
//==============================================================
@interface ChatCustomTableViewCell : ChatBaseTableViewCell
{
    TencentCardMessageCell  *_cardMessageCell;
}

@end
//==============================================================
@interface ChatSystemTableViewCell : ChatBaseTableViewCell
{
    TencentSystemMessageCell *_systemMessageCell;
}
